...
cocos2d::Scene * PlayEnvironment::createScene()
{
	// 'scene' & 'layer' are autoreleased objects
	cocos2d::Scene* menuScene = Scene::create();
	auto menuLayer = PlayEnvironment::create();
...
bool PlayEnvironment::initLayer()
{
...
void PlayEnvironment::backgroundAndTitle()
{
	// Print out the title
...
void PlayEnvironment::menuButtons()
{
	...
	runGameScene->initWithNormalSprite(
		...
		nullptr,
		CC_CALLBACK_1(PlayEnvironment::menuStartGame, this));
	...
	mainMenuExit->initWithNormalSprite(
		...
		nullptr,
		CC_CALLBACK_1(PlayEnvironment::menuCloseCallback, this));
...
void PlayEnvironment::menuStartGame(cocos2d::Ref* sender)
{
...
void PlayEnvironment::menuCloseCallback(cocos2d::Ref* pSender)
{
